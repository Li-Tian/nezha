...
public final class Log {
    ...
    public static int v(String tag, String msg) {
        if(verbose) println_native(LOG_ID_MAIN, VERBOSE, tag, msg);
        return 0;
    }
    ...
    public static int d(String tag, String msg) {
        if(verbose) println_native(LOG_ID_MAIN, DEBUG, tag, msg);
        return 0;
    }
    ...
    public static int i(String tag, String msg) {
        if(verbose) println_native(LOG_ID_MAIN, INFO, tag, msg);
        return 0;
    }
...
//        }
     ...
     * {link android. os. Drop Box Manager} and/or the process may be terminated
...
//        Logger log = loggerMap.get(tag);
//        if (log == null) {
//            log = Logger.getLogger(tag);
//            loggerMap.put(tag, log);
//        }
//        return log;
//    }
